...
#if ((S2N_OPENSSL_VERSION_AT_LEAST(1, 1, 1) && !(S2N_OPENSSL_VERSION_AT_LEAST(3, 0, 0))) || defined(OPENSSL_IS_AWSLC)) && !defined(LIBRESSL_VERSION_NUMBER) && !defined(OPENSSL_IS_BORINGSSL)
